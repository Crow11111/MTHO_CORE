...
AUDIO_FILES = [
    r"c:\ATLAS_CORE\media\Neue Aufnahme.m4a.mp4",
    r"c:\ATLAS_CORE\media\Neue Aufnahme 3.m4a.mp4",
    r"c:\ATLAS_CORE\media\Neue Aufnahme 4.m4a.mp4",
    r"c:\ATLAS_CORE\media\Neue Aufnahme 5.m4a.mp4",
    r"c:\ATLAS_CORE\media\Neue Aufnahme 6.m4a.mp4",
    r"c:\ATLAS_CORE\media\Neue Aufnahme 7.m4a.mp4",
]
...
def main():
    ...
    out_path = r"c:\ATLAS_CORE\data\session_logs\audio_transcripts_2026-03-01.md"
