# Initialisierung OC (OpenClaw) – Stammdokumente

Diese Dokumente liegen für **OC** (OpenClaw) einsehbar bereit. Sie beschreiben das Projekt ATLAS_CORE, die Rolle von OC darin, wer die Nutzer und das Team sind und warum wir das tun.

**Inhalt (Reihenfolge zum Lesen):**

1. **[PROJEKT_ATLAS.md](01_PROJEKT_ATLAS.md)** – Was wir hier machen, warum, grobe Architektur
2. **[MARC_UND_TEAM.md](02_MARC_UND_TEAM.md)** – Wer Marc ist, wer das Team ist
3. **[OC_ROLLE_UND_GRENZEN.md](03_OC_ROLLE_UND_GRENZEN.md)** – Wo OC reinpasst, Sandbox, getrennte Kanäle, ATLAS als letzte Instanz
