...
# MTHO Voice Assistant – Architektur
...
```
┌─────────────────────────────────────────────────────────────────────────────┐
│                         MTHO Voice Assistant                                │
├─────────────────────────────────────────────────────────────────────────────┤
│  Wyoming (HA)          │  MTHO_CORE                    │  Output            │
│  ─────────────         │  ───────────                    │  ──────            │
...
```
User: "Hey MTHO, Regal 80% Helligkeit"
         │
         ▼
┌─────────────────────┐
...
└─────────┬───────────┘
          ▼
┌─────────────────────┐
│ MTHO Conversation  │  HA Custom Agent → POST /webhook/inject_text
