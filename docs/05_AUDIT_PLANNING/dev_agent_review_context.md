...
- **Architektur:** [OPENCLAW_ADMIN_ARCHITEKTUR.md](OPENCLAW_ADMIN_ARCHITEKTUR.md). Admin = einzige Instanz mit allen API-Keys (Google, Anthropic, Nexos, WhatsApp, Gateway). Spine = ausführende Instanz ohne direkte Provider-Keys.
