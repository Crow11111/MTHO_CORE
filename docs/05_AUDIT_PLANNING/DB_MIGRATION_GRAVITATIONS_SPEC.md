...
**Referenz:** `docs/01_CORE_DNA/GRAVITATIONAL_QUERY_AND_CORE_AXIOMS.md`, `docs/02_ARCHITECTURE/CORE_CHROMADB_SCHEMA.md`

---

## 1. Zielbild (Gravitations-Logik)

- **Zero-State-Substrat:** Flacher Speicher; keine Tags/Pfade/Kategorien als formgebende Dimensionen im Abfrage-Raum.
...
- Zero-State im Abfrage-Raum: Ja (keine Vorab-Kontext-Struktur).
