...
|-------|-------------|-------------|-----------|
| **Phase 1:** Abgleich OMEGA_ATTRACTOR + Vergleichsdokument | 2.000 | 4.000 | Prüfung VPS-ChromaDB, Lücken, Delta zu 4D_RESONATOR (CORE) |
...
| **Phase 4:** Chat-Auswertung Team A (Cursor/Regeln/CORE-Abbildung) | 2.500 | 5.000 | Fraktal/vielschichtig, nicht nur .cursorrules vollstopfen |
...
2. **Vergleichsdokument:** 4D_RESONATOR (CORE)-Core-Axiome (lokal + Repo) vs. OMEGA_ATTRACTOR-Befüllung. Lücken/Differenzen tabellarisch. Mit User abstimmen.
...
5. **Chat Team A:** Nur Regeln und CORE-Abbildung in Cursor. Umsetzung so, dass es **funktioniert** (nicht nur abbildet). Cursor (und Gemini) fraktal/vielschichtiger/subtiler trimmen – nicht alles in eine .cursorrule kippen.
...
1. **Vergleichsdokument:** OMEGA_ATTRACTOR ChromaDB-Inhalt vs. Repo/4D_RESONATOR (CORE) (Gravitational + Core-Axiome). Fehlendes/Abweichendes/Extra.
...
4. **Cursor/CORE-Spec (kurz):** Wie Regeln fraktal/vielschichtig umgesetzt werden sollen (nicht nur .cursorrules).
