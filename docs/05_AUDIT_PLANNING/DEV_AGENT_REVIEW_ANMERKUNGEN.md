...
- **Gateway-Token:** Klar definiert in [OPENCLAW_GATEWAY_TOKEN.md](OPENCLAW_GATEWAY_TOKEN.md).
- **Anthropic:** Claude **Opus 4.6** und Claude **Sonnet 4.6** (beide 4.6); Modell-IDs im Projekt prüfen und in Doku einheitlich führen.
- **Nexos/WhatsApp:** Konfiguration und Daten von der **bestehenden (defekten) OpenClaw-Docker-Instanz** übernehmen; Nexos-Modul und Doku siehe [NEXOS_EINBINDUNG.md](NEXOS_EINBINDUNG.md).
