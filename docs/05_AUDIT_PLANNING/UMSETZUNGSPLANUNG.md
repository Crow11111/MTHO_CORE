...
- [ ] **Stammdokumente auf Server (optional, nach Rat-Freigabe):** `python -m src.scripts.deploy_stammdokumente_vps` – legt die Dokumente unter `/var/lib/openclaw/workspace/stammdokumente/` ab. Danach per WhatsApp OC informieren (Vorlage in [STAMMDOKUMENTE_DEPLOY.md](STAMMDOKUMENTE_DEPLOY.md)).

**Referenz:** [KANAL_ATLAS_OC.md](KANAL_ATLAS_OC.md), [STAMMDOKUMENTE_DEPLOY.md](STAMMDOKUMENTE_DEPLOY.md), `send_offene_punkte_to_oc.py`, `deploy_stammdokumente_vps.py`.
