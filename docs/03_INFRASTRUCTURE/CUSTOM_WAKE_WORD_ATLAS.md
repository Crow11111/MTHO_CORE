# Custom Wake Word: ATLAS

Anleitung zum Erstellen eines Custom Wake Words "ATLAS" fuer openWakeWord in Home Assistant.
...
| **Pipeline** | ATLAS (ID: `01hzktez4kncsm0sr1qx32hy5x`) |
...
1. **Navigation:** Einstellungen > Voice assistants > ATLAS > Wake word
...
## 4. Custom Wake Word "ATLAS" trainieren
...
Speicherort auf Dreadnought: `c:\ATLAS_CORE\data\openwakeword_models\`
...
| 4 | ATLAS Wake Word Samples aufnehmen | Ausstehend |
| 5 | ATLAS Custom Training durchfuehren | Ausstehend |
...
*Erstellt: 2026-03-04*
*Pipeline: ATLAS (01hzktez4kncsm0sr1qx32hy5x)*
